...
COMMON ISSUES / CONTENT ANALYSIS:
- "What are the common issues?" → {"action": "analyze_common_issues", "params": {"is_open": true}}
- "What issues does company X have?" → {"action": "analyze_common_issues", "params": {"company_name": "X"}}
- "Common problems in Help Desk queue?" → {"action": "analyze_common_issues", "params": {"queue_id": 14046773}}
- "What are people complaining about?" → {"action": "analyze_common_issues", "params": {}}
- "Analyze open ticket descriptions" → {"action": "analyze_common_issues", "params": {"is_open": true}}
